    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text mx-3">Garden</div>
            </a>
            ...
            <li class="nav-item">
                <a href="{{route('dashboard')}}" class="nav-link text-white">
                    <i class=" fas fa-home text-light fa-lg mr-2"></i>
                    Dashboard
                </a>
            </li>
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseQuanLi"
                    aria-expanded="true" aria-controls="collapseQuanLi">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>Manage</span>
                </a>
                <div id="collapseQuanLi" class="collapse show" aria-labelledby="headingQuanLi"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Table</h6>
                        <a class="collapse-item" href="{{route('advs.index')}}">Advertisements</a>
                        ...
                        <a class="collapse-item" href="{{route('posttags.index')}}">Post Tags</a>
                        <a class="collapse-item" href="{{route('posttypes.index')}}">Post Types</a>
